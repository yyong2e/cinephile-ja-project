...
<style type="text/css">
.cssbt{
	background: url(${path}/img/alp/notsel.JPG)no-repeat;
}
.seat{
margin-right: 50px; width:50%;float:left;
}
.pri{
 float:center; 
}
...
<script type="text/javascript">
	...
	function btnClick(n) {
		if( seatInfo.get(n) == null | seatInfo.get(n) == 'n' ) {
			...
			//total=total+1;
			$("#"+n).css("background-image","url(${path}/img/alp/select.JPG)", "no-repeat");
			seatInfo.set(n, 'y');	
			...
			$("#"+n).css("background-image","url(${path}/img/alp/notsel.JPG)", "no-repeat");
			//total=total-1;
			seatInfo.delete(n);
	...
	function seatReserveInit(){
		...
		while( val = mapIter.next().value){
			...
			$("#"+val[0]).css("background-image","url(${path}/img/alp/notsel.JPG)", "no-repeat");
			val[1] = 'n';
		}
		$('#info2 *').remove();
		$('#info3 *').remove();
...
<div>
	<div class="seat" id="seat" align="center">
		...
		<button onclick="btnClick('F1')" value="F1" id="F1" class="cssbt"><font color="white">1</font></button>
		<button onclick="btnClick('F2')" value="F2" id="F2" class="cssbt"><font color="white">2</font></button>&emsp;&emsp;
		<button onclick="btnClick('F3')" value="F3" id="F3" class="cssbt"><font color="white">3</font></button>
		<button onclick="btnClick('F4')" value="F4" id="F4" class="cssbt"><font color="white">4</font></button>
		<button onclick="btnClick('F5')" value="F5" id="F5" class="cssbt"><font color="white">5</font></button>
		<button onclick="btnClick('F6')" value="F6" id="F6" class="cssbt"><font color="white">6</font></button>&emsp;&emsp;
		<button onclick="btnClick('F7')" value="F7" id="F7" class="cssbt"><font color="white">7</font></button>
		<button onclick="btnClick('F8')" value="F8" id="F8" class="cssbt"><font color="white">8</font></button>
		<br>

		<img alt="라인" src="${path }/img/alp/g.JPG" width="20">
		<button onclick="btnClick('G1')" value="G1" id="G1" class="cssbt"><font color="white">1</font></button>
		<button onclick="btnClick('G2')" value="G2" id="G2" class="cssbt"><font color="white">2</font></button>&emsp;&emsp;
		<button onclick="btnClick('G3')" value="G3" id="G3" class="cssbt"><font color="white">3</font></button>
		<button onclick="btnClick('G4')" value="G4" id="G4" class="cssbt"><font color="white">4</font></button>
		<button onclick="btnClick('G5')" value="G5" id="G5" class="cssbt"><font color="white">5</font></button>
		<button onclick="btnClick('G6')" value="G6" id="G6" class="cssbt"><font color="white">6</font></button>&emsp;&emsp;
		<button onclick="btnClick('G7')" value="G7" id="G7" class="cssbt"><font color="white">7</font></button>
		<button onclick="btnClick('G8')" value="G8" id="G8" class="cssbt"><font color="white">8</font></button>
		<br>

		<img alt="라인" src="${path }/img/alp/h.JPG" width="20">
		<button onclick="btnClick('H1')" value="H1" id="H1" class="cssbt"><font color="white">1</font></button>
		<button onclick="btnClick('H2')" value="H2" id="H2" class="cssbt"><font color="white">2</font></button>&emsp;&emsp;
		<button onclick="btnClick('H3')" value="H3" id="H3" class="cssbt"><font color="white">3</font></button>
		<button onclick="btnClick('H4')" value="H4" id="H4" class="cssbt"><font color="white">4</font></button>
		<button onclick="btnClick('H5')" value="H5" id="H5" class="cssbt"><font color="white">5</font></button>
		<button onclick="btnClick('H6')" value="H6" id="H6" class="cssbt"><font color="white">6</font></button>&emsp;&emsp;
		<button onclick="btnClick('H7')" value="H7" id="H7" class="cssbt"><font color="white">7</font></button>
		<button onclick="btnClick('H8')" value="H8" id="H8" class="cssbt"><font color="white">8</font></button>
		<br>

		<img alt="라인" src="${path }/img/alp/i.JPG" width="20">
		<button onclick="btnClick('I1')" value="I1" id="I1" class="cssbt"><font color="white">1</font></button>
		<button onclick="btnClick('I2')" value="I2" id="I2" class="cssbt"><font color="white">2</font></button>&emsp;&emsp;
		<button onclick="btnClick('I3')" value="I3" id="I3" class="cssbt"><font color="white">3</font></button>
		<button onclick="btnClick('I4')" value="I4" id="I4" class="cssbt"><font color="white">4</font></button>
		<button onclick="btnClick('I5')" value="I5" id="I5" class="cssbt"><font color="white">5</font></button>
		<button onclick="btnClick('I6')" value="I6" id="I6" class="cssbt"><font color="white">6</font></button>&emsp;&emsp;
		<button onclick="btnClick('I7')" value="I7" id="I7" class="cssbt"><font color="white">7</font></button>
		<button onclick="btnClick('I8')" value="I8" id="I8" class="cssbt"><font color="white">8</font></button>
		<br>

		<img alt="라인" src="${path }/img/alp/j.JPG" width="20">
		<button onclick="btnClick('J1')" value="J1" id="J1" class="cssbt"><font color="white">1</font></button>
		<button onclick="btnClick('J2')" value="J2" id="J2" class="cssbt"><font color="white">2</font></button>&emsp;&emsp;
		<button onclick="btnClick('J3')" value="J3" id="J3" class="cssbt"><font color="white">3</font></button>
		<button onclick="btnClick('J4')" value="J4" id="J4" class="cssbt"><font color="white">4</font></button>
		<button onclick="btnClick('J5')" value="J5" id="J5" class="cssbt"><font color="white">5</font></button>
		<button onclick="btnClick('J6')" value="J6" id="J6" class="cssbt"><font color="white">6</font></button>&emsp;&emsp;
		<button onclick="btnClick('J7')" value="J7" id="J7" class="cssbt"><font color="white">7</font></button>
		<button onclick="btnClick('J8')" value="J8" id="J8" class="cssbt"><font color="white">8</font></button>
	</div>
	<div id="pri" class="col-lg-4 col-md-4" >
