...
/* 		input, textarea을 읽을 때는 val()
		...
		$('#td_'+rno).html("<textarea rows='3' colos='30' id='rt'>"+txt+"</textarea>");
		$('#btn_'+rno).html("<button onclick='up("+bno+","+rno+	")' class='btn btn-sm btn-danger'>확인</button> "+"<button onclick='lst("+bno+")' class='btn btn-sm btn-info'>취소</button>");
	}
	function up(bno,rno) {
