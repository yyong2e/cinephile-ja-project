            ...
            <div class="row">
                <div class="col-lg-6">
                        ...
                        <div class="at-feature">
                            ...
                            <div class="af-item">
                                <div class="af-text">
                                	 ...
                                	 <strong>등급: </strong> ${nmovie.mv_grade }&nbsp;
                    ...
                    <c:if test="${not empty streserve }">
                   		<div class="btn btn-success" onclick="location.href='reserve?mv_name=${nmovie.mv_name}&mv_num=${nmovie.mv_num }'">예매하기</div>
                    </c:if>
                    <c:if test="${not empty nowid }">
                    	<c:if test="${not empty cfaon }">
                    		<div class="btn btn-warning" onclick="location.href='favoritechoice?mv_num=${nmovie.mv_num}&page=0'">추천중<img src="${path}/img/hearton.png" width="25"></div>
                    	</c:if>
                    	<c:if test="${empty cfaon }">
                    		<div class="btn btn-warning" onclick="location.href='favoritechoice?mv_num=${nmovie.mv_num}&page=0'">추천하기<img src="${path}/img/heartoff.png" width="25"></div>
                    	</c:if>
					</c:if>
                </div>
